...
\ustcsetup{
  title              = {中国科学技术大学\\编译竞赛特等奖代码的分析与总结},
  title*             = {Analysis and Summary of the Compiler Contest Grand Prize Source Code},
  author             = {吉志远},
  author*            = {Ji Zhiyuan},
  speciality         = {计算接科学与技术},
  speciality*        = {Comupter Science and Technology},
  supervisor         = {徐伟~高级实验师},
  supervisor*        = {Senior Laboratory Technican Xu Wei},
